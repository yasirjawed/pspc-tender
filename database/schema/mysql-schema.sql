...
CREATE TABLE `business_industries` (
  ...
  `sorting` mediumint DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT (now()),
...
CREATE TABLE `business_profiles` (
  ...
  `industries` bigint DEFAULT NULL,
  `description` longtext,
  `name` varchar(555) DEFAULT NULL,
  `short_name` varchar(50) DEFAULT NULL,
  `origin_country` bigint DEFAULT NULL,
...
CREATE TABLE `vendors` (
  ...
  UNIQUE KEY `vendors_cnic_unique` (`cnic`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2024_12_19_060339_create_permission_tables',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_01_20_051014_create_vendors_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2025_01_20_061049_add_cnic_to_vendors_table',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2025_01_20_073329_make_columns_nullable_in_vendors_table',5);
