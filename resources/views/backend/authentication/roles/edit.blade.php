                        ...
                        <form action="{{ route('roles.update', $role->id) }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 checkbox-wrapper-13">
                                    <label for="exampleInputPassword1">Permissions:</label><br>
                                    <div class="row">
                                        @foreach ($permission as $value)
                                            <div class="col-md-2 my-2">
                                                <input type="checkbox" name="permission[]" value="{{ $value->id }}" {{ in_array($value->id, $rolePermissions) ? 'checked' : '' }} class="name"> {{ $value->name }}
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
