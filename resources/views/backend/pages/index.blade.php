...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Tender Management System Dashboard</h3>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="small-box text-bg-primary">
                        ...
                        <a href="{{ route('users.index') }}" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">All List <i class="bi bi-link-45deg"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box text-bg-success">
                        ...
                        <a href="{{ route('roles.index') }}" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">All List <i class="bi bi-link-45deg"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
