                        ...
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    @endif
                                    <form action="{{ route('web.vendor.authentication.forget-password') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="text-center pt-1 mb-1 mt-1 pb-1">
                                            <button data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-block w-100" type="submit">Request Email</button>
                                        </div>
                                        <hr>
                                    </form>
